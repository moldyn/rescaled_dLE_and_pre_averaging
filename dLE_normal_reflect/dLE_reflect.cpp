...
for (int i = 1; i < argc; ++i) {
  if(std::string(argv[i]) == "-h"){
    cout << " " <<endl;
    cout << "USAGE: ./dLE_reflect [OPTIONS]" << endl;
    cout << " " <<endl;
    ...
    cout << "OUTPUT: trajectory generated according to the Langevin equation, field estimates, trajectory reflected at borders defined seperately per coordinate" <<endl;
    cout << " " <<endl;
